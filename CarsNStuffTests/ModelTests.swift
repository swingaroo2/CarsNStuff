...
class ModelTests: XCTestCase {
    ...
    func testDealershipInfoEquality_equal() {
        let di1 = DealershipInfo(dealerId: 1234, name: "Bob's Wheelhouse")
        let di2 = DealershipInfo(dealerId: 1234, name: "Bob's Wheelhouse")
    ...
    func testDealershipInfoEquality_notEqual_dealerId() {
        let di1 = DealershipInfo(dealerId: 4321, name: "Bob's Wheelhouse")
        let di2 = DealershipInfo(dealerId: 1234, name: "Bob's Wheelhouse")
    ...
    func testDealershipInfoEquality_notEqual_name() {
        let di1 = DealershipInfo(dealerId: 1234, name: "Bob's Wheelhouse")
        let di2 = DealershipInfo(dealerId: 1234, name: "Wheel Good Deals")
        let areNotEqual = di1 == di2
